...
<body>
    ...
    {{-- <div class="" style="">
        <img src="images/Group 51343.svg" class="" style="">
    </div> --}}
    ...
    <div style="width:100%; text-align:center;color:#000000; font-size:16px; font-family: 'Rubik', sans-serif; display:flex; flex-wrap:wrap; font-weight:500px; padding:0px 0px 10px 16px; font-weight:bold; line-height:25px;">
            <div class="border-left">
        <img src="images/2.svg" class="border-left">
    </div>
    ...
    <div class="border-right">
       ...
       <div class="border-left">
        ...
        {{-- <div class="main-div-sub-text" style="text-align:center;">@if($state == null)@else{{$state}},@endif @if($country == null )@else{{$country}}@endif</div> --}}
    </div>
    ...
    <div class="main-context-card">
       ...
       <div class="border-left1">
        <img src="images/2.svg" class="border-left1">
    </div>
   
    <div class="border-right1">
        <img src="images/2.svg" class="border-right1">
    </div>
       ...
       <div class="card-div" style="padding-top:0px ;margin-top:0px">
            <div class="border-left1">
                <img src="images/2.svg" class="border-left1">
            </div>
           ...
           <p class="card-headings">Family Background</p>
           <div class="">
           <div class="border-left1">
                <img src="images/2.svg" class="border-left1">
            </div>
    ...
    <div class="flower-bottom" style="width:100%">
        <img src="images/Group 51327.svg" class="flower-bottom" style="width:100%">
    </div>
