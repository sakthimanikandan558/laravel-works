    ...
    <div class="w-full max-w-md bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form action="/store" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="email" id="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('email') }}">
                @error('email')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <label class="block text-gray-700 text-sm font-bold mb-2">
                    <input type="checkbox" name="admin" class="mr-2 leading-tight">
                    Admin
                </label>
            </div>
